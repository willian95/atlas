...
@section('content')
	...
	<div class="container">
		...
		<h3 class="center-align">Reporte por unidad</h3>
		
		<div class="row">
			<form method="POST" action="{{ url('/reportes_pdf_unidad') }}" id="form_unidad">
		...
		<h3 class="center-align">Reporte por gerencia</h3>
		
		<div class="row">
			<form method="POST" action="{{ url('/reportes_pdf_gerencia') }}" id="form_gerencia">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<div class="col l6">
					<div class="input-field col s12">
